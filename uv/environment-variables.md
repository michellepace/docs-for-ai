...
See the [project documentation](https://docs.astral.sh/uv/concepts/projects/config/#project-environment-path)
for more details.
...
Equivalent to the
[`python-downloads`](https://docs.astral.sh/uv/reference/settings/#python-downloads) setting and, when disabled, the
...
See [https://doc.rust-lang.org/std/env/fn.current\_exe.html#security](https://doc.rust-lang.org/std/env/fn.current_exe.html#security) for security
considerations.
