...
**Use cases.** Hide an output until a condition is met (*e.g.*, until algorithm
...
2. Create a [`mo.ui.refresh`](https://docs.marimo.io/api/inputs/refresh/#marimo.ui.refresh) timer that fires once a second:
...
3. Use [`mo.stop`](https://docs.marimo.io/api/control_flow/#marimo.stop) to stop execution when
...
[`mo.ui.array`](https://docs.marimo.io/api/inputs/array/#marimo.ui.array), which lets you make
...
2. Use [`mo.ui.array`](https://docs.marimo.io/api/inputs/array/#marimo.ui.array) to group together
...
2. Use [`mo.ui.dictionary`](https://docs.marimo.io/api/inputs/dictionary/#marimo.ui.dictionary) to
...
[`mo.ui.array`](https://docs.marimo.io/api/inputs/array/#marimo.ui.array), then retrieve them from the container
...
2. Use [`mo.ui.form`](https://docs.marimo.io/api/inputs/form/#marimo.ui.form) and [`Html.batch`](https://docs.marimo.io/api/html/#marimo.Html.batch) to
...
2. Use [`mo.ui.button`](https://docs.marimo.io/api/inputs/button/#marimo.ui.button) and its
...
[`mo.ui.switch`](https://docs.marimo.io/api/inputs/switch/#marimo.ui.switch).)
...
1. Use [`mo.cache`](https://docs.marimo.io/api/caching/#marimo.cache) to cache function outputs given inputs.
...
[`mo.persistent_cache`](https://docs.marimo.io/api/caching/#marimo.persistent_cache).
