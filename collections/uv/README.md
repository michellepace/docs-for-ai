...
- Curation Source (25 docs): https://github.com/astral-sh/uv/tree/main/docs — upstream markdown, fetched directly (no API tokens)
- Curation Source (3 exceptions): scraped with Firecrawl — build-generated docs with no GitHub raw source to fetch:
  - `reference-cli.md` — https://docs.astral.sh/uv/reference/cli/index.md
