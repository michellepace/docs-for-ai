...
**Repro (verified 2026-07-08):** `uv run curate-doc collections/vercel https://vercel.com/docs/this-page-does-not-exist-404-test` → `163 chars, direct`, `<title>Page Not Found</title>`, exit 0, `🏁 Success! curated doc`.
